...
(
  ...
  constraint RNVCSHS8_PK primary key (CN)
);
-- Add comments to the table 
comment on table FS_FIADB.REF_NVCS_LEVEL_8_CODES
  is 'Defines the codes for the eigth level of the National Vegetation Classification System (NVCS) hierarchy';
...
alter table FS_FIADB.REF_NVCS_LEVEL_8_CODES
  add constraint RNVCSHS8_UK unique (PRIMARY_CLASS, NVCS_CODE);
