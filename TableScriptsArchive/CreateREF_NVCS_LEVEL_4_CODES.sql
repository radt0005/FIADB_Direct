...
(
  ...
  constraint RNVCSHS4_PK primary key (CN)
);
-- Add comments to the table 
comment on table FS_FIADB.REF_NVCS_LEVEL_4_CODES
  is 'Defines the codes for the fourth level of the National Vegetation Classification System (NVCS) hierarchy';
...
alter table FS_FIADB.REF_NVCS_LEVEL_4_CODES
  add constraint RNVCSHS4_UK unique (PRIMARY_CLASS, NVCS_CODE);
