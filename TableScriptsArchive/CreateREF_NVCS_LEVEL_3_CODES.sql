...
(
  ...
  constraint RNVCSHS3_PK primary key (CN)
);
-- Add comments to the table 
comment on table FS_FIADB.REF_NVCS_LEVEL_3_CODES
  is 'Defines the codes for the third level of the National Vegetation Classification System (NVCS) hierarchy';
...
alter table FS_FIADB.REF_NVCS_LEVEL_3_CODES
  add constraint RNVCSHS3_UK unique (PRIMARY_CLASS, NVCS_CODE);
