...
(
  ...
  constraint RNVCSHS7_PK primary key (CN)
);
-- Add comments to the table 
comment on table FS_FIADB.REF_NVCS_LEVEL_7_CODES
  is 'Defines the codes for the seventh level of the National Vegetation Classification System (NVCS) hierarchy';
...
alter table FS_FIADB.REF_NVCS_LEVEL_7_CODES
  add constraint RNVCSHS7_UK unique (PRIMARY_CLASS, NVCS_CODE);
