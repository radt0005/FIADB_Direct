# TREE_obs.R generates plot level estimates
# ToDO enable domain filtering, such as specific forest types or survey units
library(RPostgreSQL)
library(readr)
library(data.table)
library(sqlparseR)
...
print(paste("From TREE_obs data_path:",data_path))
...
#source("/media/rstudio/data/Rscripts/In_progress/FIAdb_connect.R")
#source("/media/rstudio/data/Rscripts/Working/create_filter.R")
