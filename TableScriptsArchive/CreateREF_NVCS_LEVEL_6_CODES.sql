...
(
  ...
  constraint RNVCSHS6_PK primary key (CN)
);
-- Add comments to the table 
comment on table FS_FIADB.REF_NVCS_LEVEL_6_CODES
  is 'Defines the codes for the sixth level of the National Vegetation Classification System (NVCS) hierarchy';
...
alter table FS_FIADB.REF_NVCS_LEVEL_6_CODES
  add constraint RNVCSHS6_UK unique (PRIMARY_CLASS, NVCS_CODE);
