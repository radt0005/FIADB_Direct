# GB_est_w_filter.R generates FIA Green Book estimates with domain filtering 
library(RPostgreSQL)
library(readr)
library(data.table)
library(sqlparseR)
...
print(paste("From GB_est_w_filter data_path:",data_path))
source(file.path(data_path,"GB_est.R"))#Aakriti 01/13/2024
