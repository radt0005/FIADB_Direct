...
(
  ...
  constraint RNVCSHS5_PK primary key (CN)
);
-- Add comments to the table 
comment on table FS_FIADB.REF_NVCS_LEVEL_5_CODES
  is 'Defines the codes for the fifth level of the National Vegetation Classification System (NVCS) hierarchy';
...
alter table FS_FIADB.REF_NVCS_LEVEL_5_CODES
  add constraint RNVCSHS5_UK unique (PRIMARY_CLASS, NVCS_CODE);
