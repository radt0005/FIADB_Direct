# TREE_obs_w_filter.R generates tree level estimates with domain filtering
library(RPostgreSQL)
library(readr)
library(data.table)
library(sqlparseR)
...
print(paste("From TREE_obs_w_filter data_path:",data_path))
source(file.path(data_path,"TREE_obs.R"))#Aakriti 01/13/2024
#source("/home/rstudio/data/Rscripts/Working/TREE_obs.R")

#source("/home/rstudio/data/Rscripts/FIAdb_connect.R")

#if(!is.null(con))rm(con)
